...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>MyProspects</title>

        <!-- Fonts -->
        <link href="https://fonts.googleapis.com/css?family=Kaushan+Script" rel="stylesheet">
        <link href="https://fonts.googleapis.com/css?family=Nunito:200,400,400i,600,700,800" rel="stylesheet">
                    ...
                    <div class="col-lg-4">
                        ...
                        <form>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="whastapp" name="whastapp" class="form-control" placeholder="Informe seu whatsapp" />
                            </div>
        ...
        <div class="section simulations" style="background-color: #e0e0e0;color: #333;">
            <div class="container">
                ...
                <div class="text-center mt-5">
                    ...
                    <button type="button" class="btn btn-custom btn-lg mb-3">cadastre agora</button>
                    <p class="btn-disclaimer">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                </div>
            </div>
        </div>
